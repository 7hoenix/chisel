...
require_relative "../lib/chisel_temp"
require_relative "../lib/renderer"
require_relative "../lib/emphasizer"

class ChiselTempTest < Minitest::Test
  def test_acceptance_test
    skip
    # $ ruby chisel_temp.rb my_input.markdown my_output.html
    # Markdown text is: "#Hello *world*\n\nHello, **world**"
    input_file = "./lib/sample_input.markdown"
    output_file = "./lib/sample_output.html"
    chisel = ChiselTemp.new( input_file, output_file )
    output_text = chisel
  ...
  def test_it_passes_text_to_chunk_maker
    input_file = "./lib/sample_input.markdown"
    chisel = ChiselTemp.new(input_file)
